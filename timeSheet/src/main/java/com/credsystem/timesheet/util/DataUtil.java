...
public class DataUtil {
	...
	public static LocalDateTime agora() {
		...
		return LocalDateTime.of(now.getYear(), now.getMonthValue(), now.getDayOfMonth(), now.getHour(),
				now.getMinute());
	...
	public static String getHorario(DiaDeTrabalhoDTO diaDeTrabalho) {
		...
		builder.append(diaDeTrabalho.getHora()).append(" : ").append(diaDeTrabalho.getMinuto());
